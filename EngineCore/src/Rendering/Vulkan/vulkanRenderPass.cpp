...
void beginRenderPass(VkCommandBuffer commandBuffer, VkFramebuffer framebuffer, VkRenderPass renderPass, VkExtent2D extent, const std::vector<VkClearValue> &clearColors, VkOffset2D offset)
{
